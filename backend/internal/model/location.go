...
type Location struct {
	...
	CustomTargetWidthMM  *int      `json:"custom_target_width_mm,omitempty"`
	CustomTargetHeightMM *int      `json:"custom_target_height_mm,omitempty"`
...
type CreateLocationInput struct {
	...
	CustomTargetWidthMM  *int     `json:"custom_target_width_mm"`
	CustomTargetHeightMM *int     `json:"custom_target_height_mm"`
