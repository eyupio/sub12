...
export const pageHelp = {
  ...
  scoreDetail: 'Single score view. Verify, amend, or reject (for league moderators) and see the audit trail for any changes.',
  ...
  events: 'Live shooting events you can browse, join, or run. Open events accept entries; live events show a real-time scoreboard.',
  eventCreate: 'Create a new event. Pick a discipline preset, course config, and categories. Visibility controls who can find or join it.',
  eventDetail: 'Event info, participants, and current state. Owners can promote it (draft → open → live → complete), add scorers, and remove participants.',
  eventLive: 'Real-time scoreboard, auto-refreshing every 30s. Filter by category and export results as CSV.',
  eventScorecard: 'Score the event lane-by-lane. Works offline — entries queue locally and sync when you reconnect.',
  eventSettings: 'Event owner controls: visibility, delegated scorers, and danger-zone actions.',
  leagues: 'Leagues you can join or have joined. Create your own with custom scoring and join rules.',
  leagueDetail: 'League standings, submitted scores, and posts. Moderators verify and amend scores from here.',
  leagueSettings: 'League moderator controls: image, scoring rule, visibility, join policy, members and what each moderator can do.',
  ...
  clubDetail: 'Club standings, members, and posts. Moderators manage members and run leagues from here.',
  clubSettings: 'Club moderator controls: image, timezone, join policy, member roles and what each moderator can do.',
  ...
  adminEvents: 'All events on the platform. Manage events and the categories that group their participants.',
...
export const tips = {
  ...
  joinApproval: 'People request to join; moderators approve or decline.',
