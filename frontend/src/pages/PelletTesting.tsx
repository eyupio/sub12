...
function SerifNumber({ value, suffix, size = 'lg' }: { value: string; suffix?: string; size?: 'md' | 'lg' | 'xl' }) {
  ...
  return (
    <span className={`t-display-num text-ink ${sizeCls}`}>
      {value}
  ...
  return (
    <div className="space-y-8 lg:space-y-10">
      ...
      <section className="space-y-3">
        <div>
          <h2 className="t-section-title">Performance over time</h2>
      ...
      <section className="grid lg:grid-cols-2 gap-8 lg:gap-10">
        <div>
          <div className="flex items-baseline justify-between mb-3">
            <h3 className="t-subsection-title">Recent test sessions</h3>
        ...
        <div>
          <div className="flex items-baseline justify-between mb-3">
            <h3 className="t-subsection-title">Top combos</h3>
            <Link
              to="/pellet-testing"
              search={{ tab: 'combos' }}
              className="text-[11px] tracking-widest uppercase text-gold hover:opacity-80"
...
function RecentSessionRow({ test }: { test: PelletTestSessionSummary }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p className="font-medium text-base lg:text-lg text-ink leading-tight truncate">
...
function TopComboRow({
  ...
  return (
    ...
    >
      <span className="t-display-num text-2xl text-muted-2 w-6 text-center shrink-0">{rank}</span>
      <TargetThumb />
      <div className="flex-1 min-w-0">
        <p className={`font-medium text-base lg:text-lg leading-tight truncate ${highlight ? 'text-gold' : 'text-ink'}`}>
          {combo.pellet_name}
        </p>
  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <h2 className="t-section-title">Test sessions</h2>
    ...
    >
      ...
      <div className="flex-1 min-w-0 space-y-1">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <span className="font-medium text-base text-ink leading-tight truncate">
...
function CombosTab({ combos }: { combos: ComboPerformanceSummary[] }) {
  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <h2 className="t-section-title">Rifle × pellet combos</h2>
              ...
              <tbody className="divide-y divide-[var(--line)]">
                {sorted.map((c, i) => (
                  <tr key={`${c.rifle_id}-${c.pellet_id}`} className="hover:bg-bg-2/50">
                    <td className="px-4 py-3 t-display-num text-xl text-muted-2">{i + 1}</td>
                    <td className="px-4 py-3">
                      <p className="font-medium text-base text-ink leading-tight">{c.pellet_name}</p>
                    ...
                    <td className="px-4 py-3 text-right">
                      <span className="t-display-num text-lg text-gold">
...
function ComboCardMobile({ combo, rank }: { combo: ComboPerformanceSummary; rank: number }) {
  return (
    <div className="p-4 flex items-center gap-3">
      <span className="t-display-num text-2xl text-muted-2 w-6 text-center shrink-0">{rank}</span>
      <div className="flex-1 min-w-0">
        <p className="font-medium text-base text-ink leading-tight truncate">{combo.pellet_name}</p>
        <p className="text-xs text-muted truncate">{combo.rifle_name}</p>
...
function BatchesTab({ batches }: { batches: BatchReportEntry[] }) {
  return (
    <div className="space-y-5">
      <div>
        <h2 className="t-section-title">Pellet batches</h2>
    ...
    <article className="bg-surface border border-line rounded-lg p-4 lg:p-5 shadow-card space-y-4">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <h3 className="t-subsection-title">
    ...
    <div className="bg-bg min-h-screen">
      <div className="mx-auto max-w-[1100px] px-5 py-6 lg:px-12 lg:pt-7 lg:pb-20 space-y-5 lg:space-y-6 pb-32">
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
          <div>
            <h1 className="t-page-title">Pellet testing</h1>
